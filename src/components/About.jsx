        ...
        <div className='w-full bg-white py-16 px-4'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <p>Graduated the University of North Florida with a Bachelors degree in Finance. Prior to finishing my Undergraduate studies in Florida, I graduated with my Associates from Lakeland University in Tokyo, Japan. During my time in Japan, I spent 12 years working in the largest Music industry in Japan and since then I have grown a passion for Finance, Accounting and Marketing. </p>
                </div>
            </div>
        </div>
    )
